...
/**
 * Modified by ~ktemkin for use at BU.
 */

require_once($CFG->dirroot . '/question/type/shortanswer/renderer.php');
require_once($CFG->dirroot . '/question/type/scripted/question.php'); //this should change to scripted/rendered once that question type is fixed up

/**
 * Base class for generating the bits of output common to multianswerbu
 * (Cloze) questions.
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_renderer extends qtype_renderer 
{
    ...
    public function formulation_and_controls(question_attempt $qa, question_display_options $options) 
    {
        ...
        $this->page->requires->js_init_call('M.qtype_multianswerbu.init',
                array('#q' . $qa->get_slot()), false, array(
                    'name'     => 'qtype_multianswerbu',
                    'fullpath' => '/question/type/multianswerbu/module.js',
    ...
    public function subquestion(question_attempt $qa, question_display_options $options, $index, question_graded_automatically $subq) 
    {
        ...
        $renderer = $this->page->get_renderer('qtype_multianswerbu', $subrenderer);
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_multianswerbu_subq_renderer_base extends qtype_renderer {
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_textfield_renderer extends qtype_multianswerbu_subq_renderer_base {
    ...
    public function subquestion(question_attempt $qa, question_display_options $options,
        ...
        //~ktemkin:
        //also consider the possible size of the correct answer, in a scripted question type
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_multichoice_inline_renderer
        extends qtype_multianswerbu_subq_renderer_base {
    ...
    public function subquestion(question_attempt $qa, question_display_options $options,
        ...
        foreach ($subq->get_order($qa) as $value => $ansid) {
            ...
            $choices[$value] = $subq->format_text($ans->answer, $ans->answerformat, $qa, 'question', 'answer', $ansid);
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_multichoice_vertical_renderer extends qtype_multianswerbu_subq_renderer_base {
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_multichoice_horizontal_renderer
        extends qtype_multianswerbu_multichoice_vertical_renderer {
