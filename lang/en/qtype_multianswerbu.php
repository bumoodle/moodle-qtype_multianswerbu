...
/**
 * Strings for component 'qtype_multianswerbu', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['noquestions'] = 'The Cloze(multianswerbu) question "<strong>{$a}</strong>" does not contain any question';
$string['pluginname'] = 'Embedded (with BU Q-Types)';
...
$string['pluginname_link'] = 'question/type/multianswerbu';
$string['pluginnameadding'] = 'Adding an Embedded answers (BU) question';
$string['pluginnameediting'] = 'Editing an Embedded answers (BU) question';
...
';
$string['questionsless'] = '{$a} question(s) less than in the multianswerbu question stored in the database';
$string['questionsmissing'] = 'The question text must include at least one embedded answer.';
$string['questionsmore'] = '{$a} question(s) more than in the multianswerbu question stored in the database';
