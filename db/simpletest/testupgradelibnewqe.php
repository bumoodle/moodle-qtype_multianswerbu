...
/**
 * Testing the upgrade of multianswerbu question attempts.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_attempt_upgrader_test extends question_attempt_upgrader_test_base {
    public function test_multianswerbu_adaptivenopenalty_qsession104() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
    ...
    public function test_multianswerbu_adaptivenopenalty_qsession106() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswer quiz',
    ...
    public function test_multianswerbu_adaptivenopenalty_qsession108() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswer quiz',
    ...
    public function test_multianswerbu_adaptivenopenalty_qsession105() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswer quiz',
            ...
            'options' => (object) array(
                'questions' => array(
                    ...
                    6 => (object) array(
                        ...
                        'parent' => '19',
                        'name' => 'Cloze',
                        'questiontext' => '{1:SHORTBU_ANSWER_C:moodle#Feedback for moodle in lower  case ~=MOODLE#Feedback for MOODLE in upper case ~%50%Moodle#Feedback for  only first letter in upper case}',
                        'questiontextformat' => '0',
                        'generalfeedback' => '',
                        'generalfeedbackformat' => '1',
                        'defaultgrade' => '1.0000000',
...
b) What grade would you give it? _____',
    ...
    public function test_multianswerbu_adaptivenopenalty_qsession107() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswer quiz',
...
b) What grade would you give it? _____',
    ...
    public function test_multianswerbu_adaptivenopenalty_qsession109() {
        $quiz = (object) array(
            'id' => '5',
            'course' => '2',
            'name' => 'Multianswer quiz',
