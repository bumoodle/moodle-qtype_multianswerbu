...
/**
 * Unit tests for qtype_multianswerbu_question.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_question_test extends UnitTestCase {
    public function test_get_expected_data() {
        $question = test_question_maker::make_question('multianswerbu');
    ...
    public function test_summarise_response() {
        ...
        $this->assertEqual(get_string('subqresponse', 'qtype_multianswerbu',
                array('i' => 1, 'response' => 'Owl')) . '; ' .
                get_string('subqresponse', 'qtype_multianswerbu',
