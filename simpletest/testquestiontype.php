...
/**
 * Unit tests for the multianswerbu question definition class.
 *
 * @package    qtype
...
require_once($CFG->dirroot . '/question/type/multianswerbu/questiontype.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multianswerbu_test extends UnitTestCase {
    /** @var qtype_multianswerbu instance of the question type class to test. */
    protected $qtype;

    public function setUp() {
        $this->qtype = new qtype_multianswerbu();
    }
    ...
    public function test_name() {
        $this->assertEqual($this->qtype->name(), 'multianswerbu');
    }
    ...
    public function test_get_random_guess_score() {
        $q = test_question_maker::get_question_data('multianswerbu', 'twosubq');
